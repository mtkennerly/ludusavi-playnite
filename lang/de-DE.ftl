...
config-add-suffix-for-non-pc-game-names = Suche nach nicht PC Spielen durch Hinzufügen dieses Suffix am Namen (erfordert eigenen Eintrag):
...
config-ask-when-multiple-games-are-running = Erfordert eine Bestätigung wenn mehrere Spiele laufen
